...
//    	consumerOutput.runConsumer();
    	...
    	// test code
    	LocalDateTime testTime = LocalDateTime.now().withDayOfMonth(17).withHour(17).withMinute(0).withSecond(0).withNano(0);
    	...
    	OutputConsumer consumerNowOutput = new OutputConsumer("OutputEvents","80.158.16.60:9092",testTime,"E:/testEnvironment/");
